...
1. `bin/app app:create-admin-user` - создание администратора для возможности входа в админку. 
Передаваемые параметры: email и пароль
2. `bin/app app:client-scoring` - пересчет скоринга. Два режима работы:
